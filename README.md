...
"캐슬 브레이커"는 플레이어가 발사체를 사용하여 블록으로 만들어진 건물과 황금 블록을 무너뜨리는 3D 물리 기반 게임입니다. React, Three.js, Cannon-es, Tailwind CSS를 사용하여 제작되었으며, Gemini API를 활용한 AI 레벨 생성 기능도 포함하고 있습니다.
